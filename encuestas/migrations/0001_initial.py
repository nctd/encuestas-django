# Generated by Django 3.2.3 on 2022-05-09 01:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('enc_curso_id', models.AutoField(primary_key=True, serialize=False)),
                ('fecha_creacion', models.DateTimeField(auto_now=True)),
                ('alumno_curso', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='encuestas.alumnocursomodel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='alumno',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='encuestas.alumnomodel'),
        ),
        migrations.AddField(
            model_name='alumnocursomodel',
            name='curso',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='encuestas.cursomodel'),
        ),
    ]
